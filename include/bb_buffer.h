...
extern bb_result_t bb_buffer_allocate(bb_buffer_t *target, size_t width,
                                      size_t height, size_t element_size);
...
extern size_t bb_buffer_width(const bb_buffer_t *);
extern size_t bb_buffer_height(const bb_buffer_t *);
